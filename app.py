...
def add_security_headers(response):
    ...
    response.headers['Content-Security-Policy'] = "default-src 'self'; script-src 'self' 'unsafe-inline' https://js.skool.com https://cdnjs.cloudflare.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://cdnjs.cloudflare.com; font-src 'self' https://fonts.gstatic.com https://cdnjs.cloudflare.com; img-src 'self' data:; connect-src 'self';"
    return response
    ...
    if request.method == 'POST':
        ...
        if email:
            try:
                ...
                return redirect(url_for('kit_access'))
...
@app.route('/kit_access')
def kit_access():
    """Kit access page route"""
    return render_template('kit_access.html')
        ...
        <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1);">
            ...
            <div style="padding: 2rem;">
                ...
                <div style="text-align: center; margin: 2rem 0;">
                    <a href="https://anipreneur.com/kit_access" style="background: #263397; color: white; padding: 1rem 2rem; text-decoration: none; border-radius: 8px; font-weight: 600; display: inline-block; box-shadow: 0 4px 6px -1px rgba(38, 51, 151, 0.3); border: 2px solid #263397;">
                        Access Your Kit Now →
                    </a>
                </div>
